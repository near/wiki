...
Once the staking pool is deployed, you can _stake_ tokens using any of the methods offered in the [delegation docs](../../general/overview/near-token/token-delegation.md). Make sure that you are using a tool that supports TestNet and not only MainNet.
