...
3. Properly plan your tokens custody, starting from the [available custody options](../general/overview/near-token/token-custody.md).
...
5. If you are proficient with a command-line interface, look at the [delegation page](../general/overview/near-token/token-delegation.md) for a list of low-level commands you can use to stake.
