...
Please review [Event Terms & Conditions](https://shortlink.near.foundation/community-events-tandc) if hosting an event in partnership with NEAR Foundation.

Please note that the NEAR Community Events Terms and Conditions apply to participants of community events (such as quizzes, AMAs, contests, competitions, Twitter Spaces etc.) hosted by the NEAR Foundation.
