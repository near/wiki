...
And now we can line up all of these _what’s, _and get into the weeds of _how _they can be used: 
...
This, broadly speaking, is the conceptual framework you should have in mind, going forward, as we think about this emerging asset class or product in Web3. And neither the _What _nor the _How _is exhaustive! These are open dynamic categories that will evolve with the world in the future. 
