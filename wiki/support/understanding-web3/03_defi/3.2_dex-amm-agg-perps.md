---
title: DEX / AMM / Aggregators / Perps 
...
* _<span style="text-decoration:underline;">Long term focused participants and token incentives.</span>_ How can we better incentivize sticky liquidity? How can this be done, without over-inflating the token via LP payouts? 
* _<span style="text-decoration:underline;">L1 - DeFi Integration for additional incentives. </span>_ Is there a way that the block inflation of the L1 ecosystem can be harnessed with a DeFi protocol to offer users rewards such that the DeFi native token can strengthen over time? Are there certain liquidity mechanics that an L1 ecosystem can provide to a DeFi protocol, in order to ensure further liquidity is attracted into the ecosystem? 
